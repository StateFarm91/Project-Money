...
8. **Track B product research (D-009, no credentials needed):** Meta Ad Library scan of long-running consumer ads; cross-check CJ US-warehouse availability, landed cost, margin ≥ 3×, legitimacy filter; shortlist 8, pick 3; write `products/store/PRODUCT_RESEARCH.md` with evidence. Propose the brand name (conflict-checked) and domain.
