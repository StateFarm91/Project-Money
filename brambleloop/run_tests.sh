...
SUITES=(
  ...
  tests/test_geometry.py tests/test_division.py tests/test_substitution.py tests/test_prototype.py tests/test_twin.py tests/test_grading.py
  ...
  tests/test_leadtime.py tests/test_uncertainty.py tests/test_depth.py tests/test_compression.py tests/test_benchmark_matrix.py tests/test_collections.py tests/test_teams.py tests/test_fastlane.py tests/test_remerchandising.py tests/test_model_access.py tests/test_etsy_capability.py tests/test_scale.py tests/test_discipline.py tests/test_dependency.py tests/test_runrate.py
