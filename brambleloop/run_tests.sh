...
SUITES=(
  ...
  tests/test_intel.py tests/test_teardown.py tests/test_teardown_audits.py tests/test_creative.py tests/test_improve.py tests/test_growth.py tests/test_swarm.py tests/test_visual.py
