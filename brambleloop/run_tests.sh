...
SUITES=(
  ...
  tests/test_platform.py tests/test_gates.py tests/test_radar.py tests/test_arbitrage.py tests/test_provenance.py tests/test_gateway.py tests/test_model_provider.py
  tests/test_intel.py tests/test_learning.py tests/test_response.py tests/test_mission.py tests/test_teardown.py tests/test_teardown_audits.py tests/test_culture.py tests/test_creative.py tests/test_invention.py tests/test_seasonal_transform.py tests/test_universe.py tests/test_family.py tests/test_funnel.py tests/test_improve.py tests/test_league.py tests/test_roi.py tests/test_tiers.py tests/test_profiles.py tests/test_growth.py tests/test_swarm.py tests/test_visual.py
  ...
  tests/test_leadtime.py tests/test_uncertainty.py tests/test_depth.py tests/test_compression.py tests/test_collections.py tests/test_teams.py tests/test_fastlane.py tests/test_remerchandising.py tests/test_model_access.py tests/test_scale.py tests/test_discipline.py tests/test_runrate.py
