...
SUITES=(
  ...
  tests/test_etsy.py tests/test_brand.py tests/test_takeover.py tests/test_moat.py tests/test_commerce.py tests/test_intent.py tests/test_portfolio.py tests/test_preproduction.py tests/test_departments.py
