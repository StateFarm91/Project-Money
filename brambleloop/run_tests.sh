...
SUITES=(
  ...
  tests/test_intel.py tests/test_learning.py tests/test_complaints.py tests/test_deliverable.py tests/test_response.py tests/test_mission.py tests/test_pods_routing.py tests/test_teardown.py tests/test_teardown_audits.py tests/test_culture.py tests/test_cast.py tests/test_creative.py tests/test_blinded.py tests/test_prospecting.py tests/test_invention.py tests/test_seasonal_transform.py tests/test_breakthrough.py tests/test_universe.py tests/test_family.py tests/test_funnel.py tests/test_certification.py tests/test_improve.py tests/test_league.py tests/test_league_holdout.py tests/test_roles.py tests/test_freshness.py tests/test_upgrades.py tests/test_nightly.py tests/test_weekly.py tests/test_roi.py tests/test_tiers.py tests/test_profiles.py tests/test_growth.py tests/test_owned.py tests/test_swarm.py tests/test_visual.py tests/test_layout_qa.py tests/test_eligibility.py tests/test_dimensions.py tests/test_defects.py tests/test_listing_set.py tests/test_brief.py tests/test_mobile.py
