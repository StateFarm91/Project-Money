...
SUITES=(
  ...
  tests/test_intel.py tests/test_response.py tests/test_teardown.py tests/test_teardown_audits.py tests/test_culture.py tests/test_creative.py tests/test_invention.py tests/test_universe.py tests/test_improve.py tests/test_growth.py tests/test_swarm.py tests/test_visual.py
  tests/test_etsy.py tests/test_brand.py tests/test_commerce.py tests/test_departments.py
  tests/test_quality.py tests/test_physical.py tests/test_finance.py tests/test_commercial_truth.py
  tests/test_leadtime.py tests/test_model_access.py tests/test_scale.py tests/test_discipline.py tests/test_runrate.py
