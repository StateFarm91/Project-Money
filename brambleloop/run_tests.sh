...
SUITES=(
  ...
  tests/test_leadtime.py tests/test_uncertainty.py tests/test_depth.py tests/test_compression.py tests/test_collections.py tests/test_model_access.py tests/test_scale.py tests/test_discipline.py tests/test_runrate.py
