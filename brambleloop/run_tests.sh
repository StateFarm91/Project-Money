...
SUITES=(
  ...
  tests/test_etsy.py tests/test_brand.py tests/test_takeover.py tests/test_moat.py tests/test_commerce.py tests/test_intent.py tests/test_portfolio.py tests/test_preproduction.py tests/test_lanes.py tests/test_creators.py tests/test_listing_tests.py tests/test_benchmarks.py tests/test_offers.py tests/test_free_to_paid.py tests/test_replication.py tests/test_allocation.py tests/test_departments.py
  ...
  tests/test_leadtime.py tests/test_uncertainty.py tests/test_depth.py tests/test_compression.py tests/test_seasonal_cycle.py tests/test_colour.py tests/test_benchmark_matrix.py tests/test_collections.py tests/test_teams.py tests/test_fastlane.py tests/test_remerchandising.py tests/test_model_access.py tests/test_etsy_capability.py tests/test_scale.py tests/test_discipline.py tests/test_dependency.py tests/test_runrate.py
