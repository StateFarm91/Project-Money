...
if __name__ == "__main__":
    ...
    keep = ("passes","stitches_built","linked","needing_linkage","stitches_shaped_as_ordered","stitches_unframeable","closest_non_adjacent_mm","contact_floor_mm","misshapen","findings")
