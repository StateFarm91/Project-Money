...
deterministic rather than an LLM opinion (Master Plan section 3):
  ...
  height   -- relative height in stitch units, used for geometry and turning-chain rules
...
CH = _register(Stitch("ch", "chain", "chain", consumes=0, produces=1, height=0.25))
SLST = _register(Stitch("slst", "slip stitch", "slip stitch", consumes=1, produces=1, height=0.25))
SC = _register(Stitch("sc", "single crochet", "double crochet", consumes=1, produces=1, height=1.0))
HDC = _register(Stitch("hdc", "half double crochet", "half treble crochet", consumes=1, produces=1, height=2.0))
DC = _register(Stitch("dc", "double crochet", "treble crochet", consumes=1, produces=1, height=3.0))
TR = _register(Stitch("tr", "treble crochet", "double treble crochet", consumes=1, produces=1, height=4.0))

# Shaping. `inc`/`dec` are sc-based by convention; taller variants are explicit.
INC = _register(Stitch("inc", "single crochet increase", "double crochet increase", consumes=1, produces=2, height=1.0))
DEC = _register(Stitch("dec", "single crochet decrease", "double crochet decrease", consumes=2, produces=1, height=1.0))
DC_INC = _register(Stitch("dc_inc", "double crochet increase", "treble crochet increase", consumes=1, produces=2, height=3.0))
DC_DEC = _register(Stitch("dc_dec", "double crochet decrease", "treble crochet decrease", consumes=2, produces=1, height=3.0))
...
SK = _register(Stitch("sk", "skip", "miss", consumes=1, produces=0, height=0.0))
